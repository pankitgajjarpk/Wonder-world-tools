...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories ps ps--active-y" id="accordionExample">
            ...
            <li class="menu">
                <a href="setting.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu <?php if($cur_page == "user-list.php") { echo "active"; } ?>">
                <a href="user-list.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu <?php if($cur_page == "setting.php") { echo "active"; } ?>">
                <a href="setting.php" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
